...
import { OTLPLogExporter } from 'https://cdn.jsdelivr.net/npm/@opentelemetry/exporter-logs-otlp-http@0.203.0/+esm';
import { BatchLogRecordProcessor, LoggerProvider } from 'https://cdn.jsdelivr.net/npm/@opentelemetry/sdk-logs@0.203.0/+esm';
import { logs } from 'https://cdn.jsdelivr.net/npm/@opentelemetry/api-logs@0.203.0/+esm';

const logExporter = new OTLPLogExporter({
  url: 'https://otel.k3p.dev', // OpenTelemetry Collector OTLP HTTP endpoint
});
const logProcessor = new BatchLogRecordProcessor(logExporter);
logs.setGlobalLoggerProvider(new LoggerProvider()); // Create and set a LoggerProvider
//logs.getLoggerProvider().addLogRecordProcessor(logProcessor);

// Get a logger instance
const logger = logs.getLoggerProvider().getLogger('my-browser-app');

// Log an event
logger.emit({
  severityText: 'INFO',
  body: 'User clicked on the submit button.',
  attributes: {
    'user.id': '123',
